...
<head>
  ...
  <title>Sarkarijoboffer | Others | Answer Key SSC CHSl Banking Railway</title>
  <meta name="description" content="Download all exam latest Answerkey.Apply government Scholarship 2021">
  ...
  <link rel="canonical" href="https://sarkarijoboffer.in/others">
  <meta property="og:url" content="https://sarkarijoboffer.in/" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Sarkarijoboffer  | Others | Answer Key SSC CHSl Banking Railway" />
  <meta property="og:description" content="Download all exam latest Answerkey.Apply government Scholarship 2021" />
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:site" content="https://sarkarijoboffer.in/">
  <meta name="twitter:title" content="Sarkarijoboffer  | Others | Answer Key SSC CHSl Banking Railway">
  <meta name="twitter:description" content="Download all exam latest Answerkey.Apply government Scholarship 2021">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 mbxbranch">
          <table class="table-two">
            <th>Others</th>
            <?php while ($res2 = mysqli_fetch_array($schlar_result)) { ?>
              <tr>
                <td><a id="schlr_ahref" href="other/<?php echo $res2['id']; ?>/<?php echo $string_with_dashes = str_replace(' ', '-', trim($res2['pagename_schlr'])); ?>" target="_blank"><?php echo $res2['post_name_schlr']; ?></a></td>
              </tr>
            <?php } ?>
          </table>
          <div class="col-lg-12">
