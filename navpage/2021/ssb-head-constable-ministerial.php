            ...
            <!-------------------------Add------Anything------------------------->
                <div class="col-lg-9" id="subbranch">
                    ...
                    <table class="table" id="mmcb_table2" style="text-align: center;">
                          <thead>
                            <tr>
                              <th scope="row">Physical Eligibility Criteria</th>
                            </tr>
                          </thead>
                        </table>
                        <table id="mmcb_table3" style="text-align: center;width:100%;">
                              <tr>
                              <td id="border-left">Download Notification</td>
                             <td><a href="https://ssc.nic.in/SSCFileServer/PortalManagement/UploadedFiles/notice_ctgd_17072021.pdf" target="_blank">Click To Download</a></td>
                              </tr>
                        </table>
                         <table class="table" id="mmcb_table2" style="text-align: center;">
                          <thead>
