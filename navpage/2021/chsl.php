            ...
            <!-------------------------Add------Anything------------------------->
                <div class="col-lg-9" id="subbranch">
                    ...
                    <table class="table" id="mmcb_table2" style="text-align: center;">
                          <thead>
                            <tr>
                              <th scope="row">Download Admit Card</th>
                            </tr>
                          </thead>
                        </table>
                        <table id="mmcb_table3" style="text-align: center;width:100%;">
                              <tr>
                              <td id="border-left">Download Admit Card (CR Region)</td>
                             <td><a href="http://ssc-cr.org/?proceed=yes" target="_blank">Click To Download</a></td>
                              </tr>
                              <tr>
                                <td id="border-left">Download Admit Card (Other Region)</td>
                                <td><a href="http://ssc-cr.org/" target="_blank">Click To Download</a></td>
                            </tr>
                            </tbody>
                        </table>
                          <!-------------disclaimer------------->
