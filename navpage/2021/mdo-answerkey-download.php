...
<head>
    <meta charset="UTF-8">
    <title>Sarkarijoboffer  | State Government Latest Job Vacancies Available</title>
            ...
            <!-------------------------Add------Anything------------------------->
                <div class="col-lg-9" id="subbranch">
                    ...
                    <table class="table" id="mmcb_table2" style="text-align: center;">
                          <thead>
                            <tr>
                              <th scope="row">Download Answer Key</th>
                            </tr>
                          </thead>
                        </table>
                        <table id="mmcb_table3" style="text-align: center;width:100%;">
                              <tr>
                              <td id="border-left">General Knowledge</td>
                             <td><a href="https://www.bpsc.bih.nic.in//Advt/NB-2021-06-07-02.pdf" target="_blank">Click To Download</a></td>
                              </tr>
                              <tr>
                                <td id="border-left">Other</td>
                                <td><a href="https://www.bpsc.bih.nic.in//Advt/NB-2021-06-07-03.pdf" target="_blank">Click To Download</a></td>
                            </tr>
                            </tbody>
                        </table>
                          <!-------------disclaimer------------->
