...
if (isset($_GET['id'])) {
  ...
  $sql56 = "SELECT * FROM admitcard where 	id='$id'";
  $res56 = mysqli_query($mysqli, $sql56);
}
?>
<!DOCTYPE html>
<html lang="en">
<?php while ($row56 = mysqli_fetch_array($res56)) {
  $article_post_image = $row56['article_image'];
  $meta_description = $row56['meta_description'];
  $meta_keywords = $row56['meta_keywords'];
  $meta_title = $row56['meta_title'];
?>
  ...
  <head>
    ...
    <title><?php if (!empty($meta_title)) {
              echo $meta_title;
            } else {
              echo $row56['post_name_admit'];
            } ?></title>
    <meta name="description" content="<?php if (!empty($meta_description)) {
                                        echo $meta_description;
                                      } else {
                                        echo $row56['post_name_admit'];
                                      } ?>">
    <meta name="keywords" content="<?php if (!empty($meta_keywords)) {
                                      echo $meta_keywords;
                                    } else {
                                      echo $row56['post_name_admit'];
                                    } ?>">
    ...
    <script type="application/ld+json">
      {
        ...
        "headline": "<?php if (!empty($row56['Schema_headline'])) {
                        echo $row56['Schema_headline'];
                      } else {
                        echo $row56['meta_title'];
                      } ?>",
        "description": "<?php if (!empty($row56['Schema_descp'])) {
                          echo $row56['Schema_descp'];
                        } else {
                          echo $row56['meta_description'];
                        } ?>",
        "image": "<?php if (!empty($row56['article_image'])) {
                    echo $row56['article_image'];
                  } ?>",
        "author": {
          "@type": "Organization",
        ...
        "datePublished": "<?php if (!empty($row56['post_date_admit'])) {
                            echo $row56['post_date_admit'];
                          } ?>",
        "dateModified": "<?php if (!empty($row56['post_update_date_admit'])) {
                            echo $row56['post_update_date_admit'];
                          } ?> "
      }
    </script>
    ...
    <meta property="og:title" content="<?php if (!empty($meta_title)) {
                                          echo $meta_title;
                                        } else {
                                          echo $row56['post_name_admit'];
                                        } ?>" />
    <meta property="og:description" content="<?php if (!empty($meta_description)) {
                                                echo $meta_description;
                                              } else {
                                                echo $row56['post_name_admit'];
                                              } ?>" />
    ...
    <meta name="twitter:title" content="<?php if (!empty($meta_title)) {
                                          echo $meta_title;
                                        } else {
                                          echo $row56['post_name_admit'];
                                        } ?>">
    <meta name="twitter:description" content="<?php if (!empty($meta_description)) {
                                                echo $meta_description;
                                              } else {
                                                echo $row56['post_name_admit'];
                                              } ?>">
            ...
            <div class="mmcb">
              <table class="table" id="mmcb_table">
                <tbody>
                  <tr>
                    ...
                    <td id="infohd">
                      <h1><?php echo $row56['post_name_admit']; ?></h1>
                    </td>
                  </tr>
                  <tr>
                    <th scope="row" id="hd">Post Date :</th>
                    <td id="infohd"><?php echo $row56['post_date_admit']; ?> || <?php
                                                                                $posttimeadmit = $row56['post_time_admit'];
                                                                                $postadmit_T = date("g:i A", strtotime($posttimeadmit));
                                                                                echo $postadmit_T; ?>
                    </td>
                  </tr>
                  <tr>
                    <th scope="row" id="hd">Information :</th>
                    <td id="infohd"><?php echo $row56['information_admit']; ?></td>
                  </tr>
                </tbody>
              </table>
              <!-----------table-2----------------->
              <table class="table" id="mmcb_table2" style="text-align: center;">
                <thead>
                  <tr>
                    <th scope="row" id="hd2">
                      <h2><?php echo $row56['head_admit']; ?></h2>
                    </th>
                  </tr>
                </thead>
              </table>
              ...
              <table class="table" id="mmcb_table3">
                ...
                <tbody>
                  <tr>
                    <td id="border-left"><?php echo $row56['impdate_admit']; ?>
                    </td>
                    <td id="border-right"><?php echo $row56['applyfee_admit']; ?>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td id="border-left"><?php echo $row56['eligibility_admit']; ?></td>
                    <td id="border-right"><?php echo $row56['agelimit_admit']; ?>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td id="border-left"><?php echo $row56['vacancy_admit']; ?>
                    </td>
                    <td id="border-right"><?php echo $row56['postname_admit']; ?>
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  <td id="vimp" style="border-top: 0;">
                    <div style="width: 100%;padding:5px;">
                      ...
                      <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5180496463499295" crossorigin="anonymous"></script>
                      <!-- 13235 -->
                      <ins class="adsbygoogle" style="display:inline-block;width:280px;height:250px" data-ad-client="ca-pub-5180496463499295" data-ad-slot="3625978763"></ins>
                      <script>
                        (adsbygoogle = window.adsbygoogle || []).push({});
                      </script>
                    </div>
                    <div id="databs" style="margin:0px;padding:0px;width: 100%;"><?php echo $row56['additional']; ?></div>
                  </td>
                  <tr>
                    <th scope="row" id="imp" style="border-top: 0;">Important Links</th>
                  </tr>
                  <tr>
                    <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row56['admit_download']; ?>" target="_blank">Download Admitcard</a></th>
                  </tr>
                  <?php $extraLinks = $row56['extra_links']; ?>
                  ...
                  <?php } ?>
                  <tr>
                    <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row56['notification_admit']; ?>" target="_blank">Download Notification</a></th>
                  </tr>
                  <tr>
                    <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row56['offcllink_admit']; ?>" target="_blank">Official Website</a></th>
                  </tr>
                  <tr>
                    <th id="link" style="border-top: 0;"><a href="<?php echo $row56['applylink_admit']; ?>" target="_blank">Click Here To Apply Online</a></th>
                  </tr>
                </tbody>
              </table>
            <?php } ?>
          ...
          <div class="col-lg-3">
            ...
            <div class="row" id="ads-side-row">
              <div class="col-lg" id="ads-side-col">
                ...
                <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5180496463499295" crossorigin="anonymous"></script>
                <!-- menu-sidebar87552 -->
                <ins class="adsbygoogle" style="display:inline-block;width:250px;height:700px" data-ad-client="ca-pub-5180496463499295" data-ad-slot="1884418035"></ins>
                <script>
                  (adsbygoogle = window.adsbygoogle || []).push({});
                </script>
              </div>
