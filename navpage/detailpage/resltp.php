...
if (isset($_GET['id'])) {
    ...
    $sql666 = "SELECT * FROM result_home where id='$id'";
    $res666 = mysqli_query($mysqli, $sql666);
}
?>
<!DOCTYPE html>
<html lang="en">
<?php while ($row666 = mysqli_fetch_array($res666)) {
    $article_post_image = $row666['article_image'];
    $meta_description = $row666['meta_description'];
    $meta_keywords = $row666['meta_keywords'];
    $meta_title = $row666['meta_title'];
    ?>
    <head>
        <meta charset="UTF-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title><?php if (!empty($meta_title)) {echo $meta_title;} else {echo $row666['post_name_rslt'];}?></title>
        <meta name="description" content="<?php if (!empty($meta_description)) {echo $meta_description;} else {echo $row666['post_name_rslt'];}?>">
        <meta name="keywords" content="<?php if (!empty($meta_keywords)) {echo $meta_keywords;} else {echo $row666['post_name_rslt'];}?>">
    ...
    echo $url;?>"
                ...
                "headline": "<?php if (!empty($row666['Schema_headline'])) {
        echo $row666['Schema_headline'];
    } else {
        echo $row666['meta_title'];
    }?>",
                "description": "<?php if (!empty($row666['Schema_descp'])) {
        echo $row666['Schema_descp'];
    } else {
        echo $row666['meta_description'];
    }?>",
                "image": "<?php if (!empty($row666['article_image'])) {
        echo $row666['article_image'];
    }?>",
                "author": {
                    "@type": "Organization",
                ...
                "datePublished": "<?php if (!empty($row666['post_date_rslt'])) {
        echo $row666['post_date_rslt'];
    }?>",
                "dateModified": "<?php if (!empty($row666['post_update_date_rslt'])) {
        echo $row666['post_update_date_rslt'];
    }?> "
            }
        </script>
        ...
        <meta property="og:title" content="<?php if (!empty($meta_title)) {echo $meta_title;} else {echo $row666['post_name_rslt'];}?>" />
        <meta property="og:description" content="<?php if (!empty($meta_description)) {echo $meta_description;} else {echo $row666['post_name_rslt'];}?>" />
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="https://sarkarijoboffer.in/">
        <meta name="twitter:title" content="<?php if (!empty($meta_title)) {echo $meta_title;} else {echo $row666['post_name_rslt'];}?>">
        <meta name="twitter:description" content="<?php if (!empty($meta_description)) {echo $meta_description;} else {echo $row666['post_name_rslt'];}?>">
    ...
    <body>
                        ...
                        <div class="mmcb">
                            <table class="table" id="mmcb_table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="infohd">
                                            <h1><?php echo $row666['post_name_rslt']; ?></h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" id="hd">Post Date :</th>
                                        <td id="infohd"><?php echo $row666['post_date_rslt']; ?> || <?php
                                        $posttimerslt = $row666['post_time_rslt'];
                                            $postrslt_T = date("g:i A", strtotime($posttimerslt));
                                            echo $postrslt_T;?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" id="hd">Information :</th>
                                        <td id="infohd"><?php echo $row666['information_rslt']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <!-----------table-2----------------->
                            <table class="table" id="mmcb_table2" style="text-align: center;">
                                <thead>
                                    <tr>
                                        <th scope="row" id="hd2">
                                            <h2><?php echo $row666['head_rslt']; ?></h2>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                            ...
                            <table class="table" id="mmcb_table3">
                                ...
                                <tbody>
                                    <tr>
                                        <td id="border-left"><?php echo $row666['impdate_rslt']; ?>
                                        </td>
                                        <td id="border-right"><?php echo $row666['applyfee_rslt']; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="border-left"><?php echo $row666['eligibility_rslt']; ?>
                                        </td>
                                        <td id="border-right"><?php echo $row666['agelimit_rslt']; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="border-left"><?php echo $row666['vacancy_rslt']; ?>
                                        </td>
                                        <td id="border-right"><?php echo $row666['postname_rslt']; ?>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <script>
                                        ...
                                        <div id="databs" style="margin:0px;padding:0px;width: 100%;overflow:auto;"><?php echo $row666['additional']; ?></div>
                                    </td>
                                    <tr>
                                        <th scope="row" id="imp" style="border-top: 0;">Important Links</th>
                                    </tr>
                                    <tr>
                                        <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row666['download_rslt']; ?>" target="_blank">Download Result</a></th>
                                    </tr>
                                    <tr>
                                        <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row666['notification']; ?>" target="_blank">Download Notification</a></th>
                                    </tr>
                                    <?php $extraLinks = $row666['extra_links'];?>
        ...
        echo "</tr>"; ?>
                                    <?php }?>
                                    <tr>
                                        <th id="link" style="border-top: 0;border-bottom: 0;"><a href="<?php echo $row666['offcllink_rslt']; ?>" target="_blank">Official Website</a></th>
                                    </tr>
                                    <tr>
                                        <th id="link" style="border-top: 0;"><a href="<?php echo $row666['applylink_rslt']; ?>" target="_blank">Click Here To Apply Online</a></th>
                                    </tr>
                                </tbody>
                            </table>
                        <?php }?>
