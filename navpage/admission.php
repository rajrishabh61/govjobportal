...
<head>
  ...
  <title>Sarkarijoboffer | Admissions NIFT Engineering MBBS Hotel Management</title>
  <meta name="description" content="Apply online admission form. Students can apply for the admission online">
  ...
  <link rel="canonical" href="https://sarkarijoboffer.in/admissions">
  <meta property="og:url" content="https://sarkarijoboffer.in/" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Sarkarijoboffer | Admissions NIFT Engineering MBBS Hotel Management" />
  <meta property="og:description" content="Apply online admission form. Students can apply for the admission online" />
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:site" content="https://sarkarijoboffer.in/">
  <meta name="twitter:title" content="Sarkarijoboffer | Admissions NIFT Engineering MBBS Hotel Management">
  <meta name="twitter:description" content="Apply online admission form. Students can apply for the admission online">
        ...
        <div class="col-lg-8 mbxbranch">
          <table class="table-two">
            ...
            <?php while ($res3 = mysqli_fetch_array($admis_result)) { ?>
              <tr>
                <td><a id="admiss_ahref" href="admission/<?php echo $res3['id']; ?>/<?php echo $string_with_dashes = str_replace(' ', '-', trim($res3['pagename_admiss'])); ?>" target="_blank"><?php echo $res3['post_name_admiss']; ?></a></td>
              </tr>
            <?php } ?>
          </table>
          <div class="col-lg-12">
